...
use App\Models\KurikulumResource;
...
class KurikulumMataKuliahController extends Controller
{
    public function index(int $kurikulumId): JsonResponse
    {
        ...
        return $this->successCollection(KurikulumResource::collection($kurikulum), 'Data Kurikulum berhasil diambil');
    }
    ...
    public function store(int $kurikulumId, ManageMataKuliahRequest $request): JsonResponse
    {
        ...
        return $this->successMessage('Mata kuliah ditambahkan ke kurikulum', 201);
    }
