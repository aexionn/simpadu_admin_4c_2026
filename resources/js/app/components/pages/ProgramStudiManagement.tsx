...
const prodiData = [
  { id: 1, kode: "1", nama: "D3 Teknik Informatika", jurusan: "Jurusan Teknik Informatika", status: "Aktif" },
  { id: 2, kode: "2", nama: "D4 Teknik Informatika", jurusan: "Jurusan Teknik Informatika", status: "Aktif" },
  { id: 3, kode: "3", nama: "D3 Sistem Informasi", jurusan: "Jurusan Teknik Informatika", status: "Aktif" },
  { id: 4, kode: "4", nama: "D3 Teknik Elektro", jurusan: "Jurusan Teknik Elektro", status: "Aktif" },
  { id: 5, kode: "5", nama: "D3 Teknik Sipil", jurusan: "Jurusan Teknik Sipil", status: "Aktif" },
  { id: 6, kode: "6", nama: "D3 Akuntansi", jurusan: "Jurusan Akuntansi", status: "Aktif" },
];

function mapProgramStudi(item: any) {
  const nama = valueOf(item.NAMA_PRODI, item.nama_prodi, item.nama, item.name);
  ...
  return {
    ...
    kode: String(valueOf(item.ID_PRODI, item.id_prodi, item.id, "-")),
    nama,
    jurusan,
...
export default function ProgramStudiManagement() {
  ...
  const filteredData = data.filter((item) => {
    ...
    const matchesFilter = filterJurusan === "all" || item.jurusan === filterJurusan;
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Kelola data program studi di POLIBAN</p>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-fixed">
            <thead className="bg-gray-50">
              <tr>
                <th className="w-32 px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">ID Prodi</th>
                <th className="w-2/5 px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Program Studi</th>
                <th className="w-2/5 px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Jurusan</th>
                <th className="w-32 px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase">Status</th>
      ...
      >
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
            ...
            >
              {editData ? "Simpan Perubahan" : "Tambah Program Studi"}
            </button>
          </div>
        </form>
      </Modal>
