...
const mataKuliahData = [
    ...
    { id: 4, nama: "Basis Data", sks: 3, semester: 3, jam: 2, status: "Aktif" },
    {
        id: 5,
    ...
    {
        id: 8,
        nama: "Analisis dan Perancangan SI",
        sks: 4,
        semester: 3,
        jam: 3,
        status: "Aktif",
...
function mapMataKuliah(item: any) {
    const nama = valueOf(item.NAMA_MK, item.nama_mk, "Mata Kuliah");

    return {
        id: valueOf(item.ID_MK, item.id_mk, 0),
        nama,
        sks: Number(valueOf(item.SKS,item.sks, 0)),
        semester: Number(valueOf(item.SEMESTER, item.semester, 0)),
        jam: Number(valueOf(item.JAM, item.jam, 0)),
...
export default function MataKuliahManagement() {
    ...
    const filteredData = data.filter((item) => {
        ...
        const matchesSemester =
            filterSemester === "all" ||
            item.semester.toString() === filterSemester;
        ...
        <div className="p-8">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">
                    Kelola data mata kuliah di POLIBAN
                </p>
            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg">
                            <p className="text-sm text-blue-800">
                                <strong>Catatan:</strong> Semua mata kuliah di
                                politeknik bersifat wajib.
                            </p>
                        </div>
