    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-blue-900 text-white flex flex-col fixed h-full">
        ...
        <div className="p-4 border-t border-blue-800">
          {/* User badge */}
          {user && (
            <div className="flex items-center gap-3 px-2 py-2 mb-2 rounded-lg bg-blue-800">
              <div className="w-8 h-8 bg-white text-blue-900 rounded-full flex items-center justify-center text-xs font-bold shrink-0">
                {initials}
              </div>
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-2 w-full text-sm text-blue-100 hover:bg-blue-800 rounded transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
